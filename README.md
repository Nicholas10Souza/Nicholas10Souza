...
<div class="flex flex-wrap justify-center gap-6 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
  ...
  <img alt="Github" title="GitHub" class="w-8 h-8 md:w-9 md:h-9 hover:scale-110 transition-transform" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" width="40" height="40">
